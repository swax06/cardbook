...
// declare function acceptsColor<T extends string>(color: Color<T>): void

// acceptsColor('#aaa')
// acceptsColor('#gaa')
// acceptsColor('#cccccc')
// acceptsColor('red')
// acceptsColor('inherit')
// acceptsColor('#aaaa')
// acceptsColor('rgb(1,2,3)')
// acceptsColor('rgb(300, 20, 1)')
// acceptsColor('rgba(20,30,40)')
// acceptsColor('rgba(20,30,40,0.05)')
// acceptsColor('hsl(360,     4%, 10%)')
// acceptsColor('hsla(0, 10%, 20%, 0.555)')
// acceptsColor('hsl(400, 0, 1)')
// acceptsColor('hsl(360, 20%, 10)')